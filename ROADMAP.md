...
- Added an optional OrcaSlicer project 3MF export for Filament Relief so Orca can open the project with filament slots and manual tool-change markers from the color plan.
...
3. **Slicer-ready color project export hardening**
   - Keep validated generic 3MF export as the safe default handoff format.
   - Keep hardening the optional OrcaSlicer project export with more real-world Orca-open checks.
